...
public class BaseResidentService implements ResidentService {
    ...
    public BaseResidentService(ResidentRepository residentRepository) {
     ...
     */
    @Override
    public Resident getUniqueResident(Resident filterResident) throws ResidentServiceException, ParseException {
     ...
     */
    @Override
    public List<Resident> getFilteredResidentsList(Resident filterResident) throws ParseException {
